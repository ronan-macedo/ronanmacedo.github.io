...
document.getElementById('sodapopulation').innerHTML = townData.towns[5].currentPopulation;
document.getElementById('sodarain').innerHTML = townData.towns[5].averageRainfall;
...
document.getElementById('fishpopulation').innerHTML = townData.towns[1].currentPopulation;
document.getElementById('fishrain').innerHTML = townData.towns[1].averageRainfall;
